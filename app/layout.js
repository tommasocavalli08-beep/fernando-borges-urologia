...
const schema={'@context':'https://schema.org','@graph':[
 {'@type':'Physician','@id':physicianId,name:'Dr. Fernando Borges Ribeiro',jobTitle:'Médico Urologista',description:'Médico urologista dedicado à saúde masculina integral, andrologia, saúde sexual, uro-oncologia, cálculos renais e cirurgia urológica.',url:`${base}/sobre`,image:{'@type':'ImageObject',url:portrait,width:1122,height:1402},telephone:'+5566981512722',medicalSpecialty:'Urology',identifier:[{'@type':'PropertyValue',name:'CRM-MT',value:'4737'},{'@type':'PropertyValue',name:'CRM-SP',value:'155372'},{'@type':'PropertyValue',name:'RQE Urologia',value:'1713'},{'@type':'PropertyValue',name:'RQE Cirurgia Geral',value:'1451'}],knowsAbout:['Saúde masculina integral','Andrologia','Disfunção erétil','Doença de Peyronie','Ejaculação precoce','Testosterona','Câncer de próstata','Câncer de rim','Cálculos renais','Cirurgia robótica urológica'],workLocation:[{'@id':clinicMtId},{'@id':clinicSpId}],sameAs:['https://www.instagram.com/fernandoborges.uro/']},
 {'@type':['MedicalClinic','LocalBusiness'],'@id':clinicMtId,name:'Instituto Fernando Borges',alternateName:'Instituto Fernando Borges — Saúde Masculina, Andrologia e Urologia Avançada',url:base,description:'Atendimento médico em saúde masculina integral e urologia.',telephone:'+5566981512722',address:{'@type':'PostalAddress',streetAddress:'Rua José Salmen, 603 — Vila Birigui',addressLocality:'Rondonópolis',addressRegion:'MT',postalCode:'78705-057',addressCountry:'BR'},areaServed:{'@type':'City',name:'Rondonópolis'},medicalSpecialty:'Urology',founder:{'@id':physicianId},sameAs:['https://www.instagram.com/fernandoborges.uro/']},
 {'@type':['MedicalClinic','LocalBusiness'],'@id':clinicSpId,name:'Instituto RegeneraDOR',url:'https://institutoregenerador.com/',description:'Local de atendimento presencial do Dr. Fernando Borges Ribeiro em São Paulo.',telephone:'+5566981512722',address:{'@type':'PostalAddress',streetAddress:'Avenida Jamaris, 100 — Conjunto 1301',addressLocality:'São Paulo',addressRegion:'SP',postalCode:'04078-000',addressCountry:'BR'},areaServed:{'@type':'City',name:'São Paulo'},medicalSpecialty:'Urology',employee:{'@id':physicianId},sameAs:['https://www.instagram.com/instituto_regenerador/']},
 ...
 {'@type':'WebPage','@id':`${base}/#webpage`,url:base,name:'Instituto Fernando Borges',isPartOf:{'@id':`${base}/#website`},about:{'@id':physicianId},primaryImageOfPage:{'@type':'ImageObject',url:portrait},inLanguage:'pt-BR'}
]};
