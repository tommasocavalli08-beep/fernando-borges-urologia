...
export const metadata={
 ...
 keywords:['urologista em Rondonópolis','urologista São Paulo','saúde masculina integral','andrologia','disfunção erétil','reposição de testosterona','fertilidade masculina','infertilidade masculina','doença de Peyronie','ejaculação precoce','câncer de próstata','câncer de rim','cálculos renais','cirurgia robótica urológica','Clube do Check-Up'],
...
const schema={'@context':'https://schema.org','@graph':[
 {'@type':['Person','Physician'],'@id':physicianId,name:'Dr. Fernando Borges Ribeiro',jobTitle:'Médico Urologista',description:'Médico urologista dedicado à saúde masculina integral, andrologia, saúde sexual, fertilidade masculina, uro-oncologia, cálculos renais e cirurgia urológica.',url:`${base}/sobre`,image:{'@type':'ImageObject',url:portrait,width:1122,height:1402},telephone:'+5566981512722',medicalSpecialty:'https://schema.org/Urologic',identifier:[{'@type':'PropertyValue',name:'CRM-MT',value:'4737'},{'@type':'PropertyValue',name:'CRM-SP',value:'155372'},{'@type':'PropertyValue',name:'RQE Urologia',value:'1713'},{'@type':'PropertyValue',name:'RQE Cirurgia Geral',value:'1451'}],knowsAbout:['Saúde masculina integral','Andrologia','Disfunção erétil','Doença de Peyronie','Ejaculação precoce','Testosterona','Fertilidade masculina','Infertilidade masculina','Câncer de próstata','Câncer de rim','Cálculos renais','Cirurgia robótica urológica'],workLocation:[{'@id':clinicMtId},{'@id':clinicSpId}],subjectOf:{'@id':mediaId},sameAs:['https://www.instagram.com/fernandoborges.uro/']},
 ...
 {'@type':['MedicalClinic','LocalBusiness'],'@id':clinicSpId,name:'Instituto RegeneraDOR',url:'https://institutoregenerador.com/',description:'Local de atendimento presencial do Dr. Fernando Borges Ribeiro em São Paulo.',telephone:'+5511998400066',address:{'@type':'PostalAddress',streetAddress:'Avenida Jamaris, 100 — Conjunto 1301',addressLocality:'São Paulo',addressRegion:'SP',postalCode:'04078-000',addressCountry:'BR'},areaServed:{'@type':'City',name:'São Paulo'},medicalSpecialty:'https://schema.org/Urologic',employee:{'@id':physicianId},sameAs:['https://www.instagram.com/instituto_regenerador/']},
